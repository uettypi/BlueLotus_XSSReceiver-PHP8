...
function rc4($data_str, $key_str) {
    // Guard: if an empty key is provided, normalize it to a single NUL byte
    // to avoid division-by-zero when computing modulo by key length.
    // This preserves behavior (no crash) while keeping function signature
