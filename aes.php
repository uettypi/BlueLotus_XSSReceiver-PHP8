...
function AESEncryptCtr($plaintext, $password = "blue-lotus", $nBits = 128) {
    ...
    // ensure slice length is integer to avoid implicit float->int conversion warnings
    $key = array_merge($key, array_slice($key, 0, (int)($nBytes - 16))); // expand key to 16/24/32 bytes long 
